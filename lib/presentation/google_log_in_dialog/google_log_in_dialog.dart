import '../google_log_in_dialog/widgets/google_log_in_item_widget.dart';
                    ...
                    child: Padding(
                      ...
                      child: Obx(
                        () => ListView.separated(
                          ...
                          itemCount: controller.googleLogInModelObj.value
                              .googleLogInItemList.value.length,
                          itemBuilder: (context, index) {
                            GoogleLogInItemModel model = controller
                                .googleLogInModelObj
                                .value
                                .googleLogInItemList
                                .value[index];
                            return GoogleLogInItemWidget(
                              model,
                            );
                          },
                        ),
